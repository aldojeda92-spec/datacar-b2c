...
// ... [MANTENGO TUS ICONOS Y INTERFACES EXACTAMENTE IGUALES] ...
const Icons = {
...
export default function WizardContainer() {
  ...
  // ... [MANTENGO TODAS TUS FUNCIONES toggleArrayItem, handleMinChange, etc.] ...
    ...
    <div className={`min-h-screen font-sans ${step === 2 ? 'bg-slate-50' : 'bg-white'}`}>
      ...
      <div className="max-w-[1600px] mx-auto p-6 md:p-8 flex justify-between items-center border-b border-slate-100 bg-white">
        <div className="flex items-center gap-4">
          <div className="bg-[#006837] text-white font-sans font-extrabold text-2xl px-3.5 py-1.5 rounded-full tracking-tight shadow-md">CU</div>
      ...
      {step === 1 && (
        <div className="max-w-4xl mx-auto p-6 md:p-10">
          <div className="bg-white border border-slate-100 p-8 md:p-12 shadow-xl rounded-xl space-y-10">
            ...
            <div className={`space-y-10 bg-slate-50/50 p-6 rounded-lg border border-slate-100 shadow-inner ${paymentMode === 'financed' ? 'opacity-40 pointer-events-none' : ''}`}>
        ...
        <div className="max-w-[1700px] mx-auto p-4 md:p-8 pb-40 animate-in fade-in duration-700 space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-6">
            {displayedAutos.map((auto) => {
              ...
              // INYECCIÓN: Si está en financiado, calculamos la cuota
